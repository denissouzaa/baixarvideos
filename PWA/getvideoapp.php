...
if ($my_type == 'Baixar') {
	...
	for ($i = 0; $i < count($avail_formats); $i++) {
		...
		if($config['VideoLinkMode']=='proxy'||$config['VideoLinkMode']=='both')
			 echo '</font> ';
			 echo "<a href=\"#\" onclick=\"openUrl('".$avail_formats[$i]['url']."&title=".$cleanedtitle."'); return false;\" style=\"color:#3CB371\" class=\"mime\">- Baixar</a> ";
...
© 2015 | Esse site não pertence ao youtube, é um site independente com o intuito de ajudar os usuários.
 </div></div>
<br>
</body>
</html>