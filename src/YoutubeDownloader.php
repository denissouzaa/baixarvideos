...
class YoutubeDownloader
{
	...
	public static function validateVideoId($video_id)
	{
		...
		$Ver1 = strpos($video_id, "watch?v=");
		$Ver2 = strpos($video_id, ".be/");
		$Ver3 = strpos($video_id, "/?#/");
		$VerApp = strpos($video_id, "shared?ci=");
		
        if ($Ver1 == true){
	
		$Ver4 = explode("&", $video_id);
